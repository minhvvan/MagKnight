...
public class ClearUIController : MonoBehaviour, IBasePopupUIController
{
    [SerializeField] RectTransform _clearTextTransform;
    ...
    void Initialize()
    {
        ...
        _clearTextTransform.anchoredPosition = new Vector2(0,0);
    }
    ...
    void AnimateShowUI()
    {
        ...
        sequence.Append(_backgroundCanvasGroup.DOFade(1, _fadeDuration))
                .Append(_clearTextTransform.DOLocalMoveY(200, _fadeDuration))
